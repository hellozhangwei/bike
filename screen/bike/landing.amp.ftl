<main id="content" role="main" class="main commerce-landing">
  <section class="commerce-hero-content-wrapper center overflow-hidden">
    <a href="product-listing" class="text-decoration-none block">
      ...
      <amp-img
        class="commerce-hero-image"
        src="/bikestatic/img/e-commerce/wide-landing-01.jpg"
        width="2560"
        height="800"
        layout="responsive"
  ...
  <section class="commerce-hero-content-wrapper center overflow-hidden">
    <a href="blog-listing" class="text-decoration-none block">
      ...
      <amp-img
        class="commerce-hero-image"
        src="/bikestatic/img/e-commerce/wide-landing-02.jpg"
        width="2560"
        height="800"
        layout="responsive"
        media="(min-width: 52.07rem)"
  ...
  <section class="commerce-hero-content-wrapper center overflow-hidden">
    <a href="product-listing" class="text-decoration-none block">
      ...
      <amp-img
        class="commerce-hero-image"
        src="/bikestatic/img/e-commerce/wide-landing-03.jpg"
        width="2560"
        height="800"
        layout="responsive"
        media="(min-width: 52.07rem)"
  ...
  <section class="commerce-hero-content-wrapper center overflow-hidden">
    <a href="blog-listing" class="text-decoration-none block">
      ...
      <amp-img
        class="commerce-hero-image"
        src="/bikestatic/img/e-commerce/wide-landing-04.jpg"
        width="2560"
        height="800"
        layout="responsive"
        media="(min-width: 52.07rem)"
