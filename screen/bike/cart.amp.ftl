...
<main
  id="content"
  role="main"
  class="main items-start commerce-cart pb3 md-pb7 md-mb3"
>
  <div class="flex flex-wrap">
    <section class="col-12 md-col-8 pt2 pb3 md-pt4 md-pb7">
      <h1 class="h3 mb2 mx2 md-mx4">Your Basket</h1>
      <div
    ...
    >
      ...
      <dl class="flex flex-wrap">
        ...
        <dd class="m0 col-2 pb1 right-align">&#163;30</dd>
        <dt class="commerce-cart-total col-10 pt2 pb2 bold mt3 mb2">
          Total
        </dt>
        <dd
  ...
  <section
    class="commerce-related-products col-12 px2 md-mt5 md-px4 xs-hide sm-hide"
  >
