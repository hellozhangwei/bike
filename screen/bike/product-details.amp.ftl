...
<main id="content" role="main" class="main">
  <div class="commerce-cart-notification fixed col-12 right-0 mx0 md-mx2">
    ...
    <div class="flex p2 mxn1 md-py3">
      <a
        href="#"
        class="ampstart-btn ampstart-btn-secondary caps center col col-6 mx1"
        >send</a
      >
      <a
        href="checkout.amp.html"
        class="ampstart-btn caps center col col-6 mx1"
        >checkout</a
      >
    </div>
  </div>
    ...
    >
          ...
          <ul class="m0 list-reset inline-block">
            <li class="inline-block mr1">
              <div
                option="black"
                selected="selected"
                class="commerce-product-color-swatch commerce-product-color-black"
              ></div>
            </li>
            <li class="inline-block mr1">
              <div
                option="blue"
                class="commerce-product-color-swatch commerce-product-color commerce-product-color-blue"
              ></div>
            </li>
          </ul>
        </amp-selector>
      ...
      <div class="col-6 self-start pb4">
        <div class="commerce-select-wrapper inline-block">
          <label for="sizes" class="bold caps h6 md-h7"
            >Select a size:
          </label>
          ...
          <div class="pt3 md-pt4 md-pb4">
            ...
            <section class="mb3">
              ...
              <p class="mt1">
                ...
                velit aliquet. Maecenas sed diam eget risus varius blandit
                sit amet non magna.
              </p>
            </section>
            <section class="mb3">
        ...
        <section class="pt3 pb3 md-pt4 md-pb4 px2">
          ...
          <div class="mt2">
            <dl class="flex flex-wrap">
              ...
              <dt class="h7 col-4 sm-col-3 md-col-5 lg-col-4 pb1">
                handlebars
              </dt>
              <dd class="m0 col-8 sm-col-9 md-col-7 lg-col-8 pb1">
                Chrome plated
            ...
            <ul class="list-reset">
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  ...
                  <h2 class="commerce-related-product-name h6">
                    Sprocket Set
                  </h2>
                </a>
              </li>
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  <amp-img
                    class="mb2"
                    src="/bikestatic/img/e-commerce/product/product-2.jpg"
                    width="1"
                    height="1"
                    layout="responsive"
                    alt="Fixie Blue"
              ...
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  <amp-img
                    class="mb2"
                    src="/bikestatic/img/e-commerce/product/product-3.jpg"
                    width="1"
                    height="1"
                    layout="responsive"
                    alt="Chain set"
              ...
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  <amp-img
                    class="mb2"
                    src="/bikestatic/img/e-commerce/product/product-4.jpg"
                    width="1"
                    height="1"
                    layout="responsive"
                    alt="Leather Saddle"
              ...
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  <amp-img
                    class="mb2"
                    src="/bikestatic/img/e-commerce/product/product-5.jpg"
                    width="1"
                    height="1"
                    layout="responsive"
                    alt="16-Speed"
              ...
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  <amp-img
                    class="mb2"
                    src="/bikestatic/img/e-commerce/product/product-6.jpg"
                    width="1"
                    height="1"
                    layout="responsive"
                    alt="Red Cruiser"
              ...
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  <amp-img
                    class="mb2"
                    src="/bikestatic/img/e-commerce/product/product-7.jpg"
                    width="1"
                    height="1"
                    layout="responsive"
                    alt="Horn Handles"
              ...
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  <amp-img
                    class="mb2"
                    src="/bikestatic/img/e-commerce/product/product-9.jpg"
                    width="1"
                    height="1"
                    layout="responsive"
                    alt="Road Bike"
              ...
              <li class="commerce-related-product inline-block mr2">
                ...
                >
                  <amp-img
                    class="mb2"
                    src="/bikestatic/img/e-commerce/product/product-10.jpg"
                    width="1"
                    height="1"
                    layout="responsive"
                    alt="Wheel Set"
